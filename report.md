...
Целью данной лабораторной работы является изучение задачи нескольких коммивояжёров с минимизацией времени обхода (mTSP-makespan), построение QUBO-формулировки данной задачи, реализация двух алгоритмов оптимизации — жадного алгоритма с локальными улучшениями (Greedy + 2-opt) и квантово-вдохновлённого метода имитации отжига (Simulated Annealing) — а также проведение сравнительного анализа их эффективности на индивидуальном варианте задачи.
...
Для варианта №2 заданы следующие исходные данные:
- число городов: **12**;
- множество городов:
...
2. каждый агент получил **хотя бы один город** для посещения;
